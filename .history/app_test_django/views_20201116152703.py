...
def view_dashboard(request):
    ...
    trips_for_user = Trip.objects.filter(uploaded_by_id=request.session['user_id'])
    context = {
        "user": user,
        "user_trips": trips_for_user
    }
    print(trips_for_user)
...
def create_trip(request):
    ...
    return redirect("/dashboard<int:trip_id)")
